# Generated by Django 4.0.4 on 2022-07-25 20:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('demande_date', models.DateField(blank=True, db_column='DEMANDE_date', null=True)),
                ('demande_personel_destination', models.IntegerField(blank=True, db_column='DEMANDE_PERSONEL_destination', null=True)),
                ('demande_lien', models.CharField(blank=True, db_column='DEMANDE_lien', max_length=50, null=True)),
            ],
            options={
                'db_table': 'demande',
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('depense_date', models.DateField(blank=True, db_column='Depense_date', null=True)),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(db_column='DEMANDE_PERSONEL_id', on_delete=django.db.models.deletion.DO_NOTHING, to='App.personel'),
        ),
        migrations.AddField(
            model_name='commande',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('appartenir_dte', models.DateField(blank=True, db_column='APPARTENIR_dte', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('affecter_dte', models.DateField(blank=True, db_column='AFFECTER_dte', null=True)),
                ('bureaux_bureaux', models.ForeignKey(db_column='BUREAUX_BUREAUX_id', on_delete=django.db.models.deletion.DO_NOTHING, to='App.bureaux')),
